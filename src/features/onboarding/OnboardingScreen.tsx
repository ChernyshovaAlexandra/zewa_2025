...
const steps = [
  ...
  },
  {
    ...
    text: applyNbsp(
      `Проходите игру «Снова в школу» неограниченное количество раз даже без загрузки чеков. Ловите больше предметов! Лучший игрок недели получит подарок.`,
    ),
  },
  {
    image: './assets/images/onboarding/main/img3.jpg',
    header: applyNbsp(`Продвигайтесь по шкале, чтобы участвовать в розыгрыше призов`),
    text: applyNbsp(
      'Для этого покупайте товары Zewa в магазинах «Магнит» или приложении «Магнит: акции и доставка», загружайте чеки, ловите монеты в игре и приглашайте друзей.',
    ),
  },
  {
    ...
    text: applyNbsp(
      'Это увеличивает шансы на получение ценных подарков — от скидок и годового запаса Zewa до техники и Главного приза. Каждую неделю шкала обнуляется — начните с чистого листа и побеждайте снова!',
    ),
  },
];
