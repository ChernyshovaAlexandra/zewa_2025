          ...
          {toggledContent && (
            <>
              ...
              <Description>
                {coupon.code
                  ? applyNbsp(
                      `Акция действует в приложении «Магнит: акции и доставка» (6+) в разделе «Доставка», в котором реализуется Продукция в период с ${PROMO_START_DATE_SHORT} по ${DISCOUNT_EXPIRY_SHORT}. Скидка предоставляется в приложении на все позиции бренда Zewa при применении промокода. Скидка не распространяется на товары с шильдиком "Финальная цена" и не суммируется с другими скидками и предложениями. Количество акционных товаров ограничено. В период проведения акции не гарантируется постоянное наличие полного ассортимента акционных товаров.`,
                    )
