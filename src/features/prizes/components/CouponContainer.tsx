...
Используйте промокод при заказе онлайн.`)
          ...
          <Flex justify="space-between">
            <Description style={{ marginBottom: 0 }}>Скидка действует до 11.01.2026</Description>
            <ToggleButton
              type="button"
