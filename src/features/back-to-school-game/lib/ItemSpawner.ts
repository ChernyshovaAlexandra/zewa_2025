import { ITEM_CATALOG, type ItemKind } from '@/features/back-to-school-game/constants/items';
import type { Item } from '@/features/back-to-school-game/model/gameModelStore';
